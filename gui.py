...
class SmartScan(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        b3 = Button(self, height=2, width=20, text="Add Faculty Face Data", bg="#ffffff",activebackground = "#0077CC", bd=2 , 
...
class Inserts(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        img.image = render
        img.place(x=1, y=1, relwidth=1, relheight=1)
        message = tk.Label(self, text="Enroll Faculty Face Data" ,justify = CENTER , width=40  ,height=2,font=('Hetelvica', 16,'bold' )) 
